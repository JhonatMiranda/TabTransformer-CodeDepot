...
# Carrega o conjunto de dados do CSV
adult_data = df = pd.read_csv("adult.csv")
...
X = adult_data[CSV_HEADER[:-1]]  # Todas as colunas, exceto a última (rótulo 'y')
y = adult_data['income']  # A última coluna (rótulo 'y')
...
CATEGORICAL_FEATURES_WITH_VOCABULARY = {
    "workclass": sorted(list(adult_data["workclass"].unique())),
    "education": sorted(list(adult_data["education"].unique())),
    "marital-status": sorted(list(adult_data["marital-status"].unique())),
    "occupation": sorted(list(adult_data["occupation"].unique())),
    "relationship": sorted(list(adult_data["relationship"].unique())),
    "race": sorted(list(adult_data["race"].unique())),
    "gender": sorted(list(adult_data["gender"].unique())),
    "native-country": sorted(list(adult_data["native-country"].unique())),
}
