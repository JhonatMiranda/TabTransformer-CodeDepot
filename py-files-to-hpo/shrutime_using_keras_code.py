...
CSV_HEADER = ["CreditScore", "Geography", "Gender", "Age", "Tenure", "Balance", "NumOfProducts", "HasCrCard", "IsActiveMember",
    "EstimatedSalary", "Exited"]

# Carrega o conjunto de dados do CSV
shrutime_data = df = pd.read_csv("Churn_Modelling.csv")
shrutime_data.drop("RowNumber", axis = 1, inplace = True)
shrutime_data.drop("CustomerId", axis = 1, inplace = True)
shrutime_data.drop("Surname", axis = 1, inplace = True)
...
X = shrutime_data[CSV_HEADER[:-1]]  # Todas as colunas, exceto a última (rótulo 'y')
y = shrutime_data['Exited']  # A última coluna (rótulo 'y')
...
CATEGORICAL_FEATURES_WITH_VOCABULARY = {
    "Geography": sorted(list(df_train["Geography"].unique())),
